...
export default function RevealSlideTemplate({ data, location }) {
  const slideMarkdown = data.markdownRemark

  return (
    <Layout location={location} title={data.site.siteMetadata.title} presentFooter={false}>
      <SEO
      ...
      <div className="container">
        <Helmet>
          <script src={withPrefix('activate-reveal.js')} />
        </Helmet>
        <div
